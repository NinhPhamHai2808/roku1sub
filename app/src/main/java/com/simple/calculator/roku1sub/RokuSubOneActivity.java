...
public class RokuSubOneActivity extends Activity implements InappNoconsumer.OnPurchaseListener, InappConsumer.OnPurchaseListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.roku_sub_one);
        ...
        imgTry.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    InappNoconsumer.getInstance(RokuSubOneActivity.this).buySubcription(RokuSubOneActivity.this);
                } catch (Exception e) {
                    Intent intent = new Intent(RokuSubOneActivity.this, RokuSubTwoActivity.class);
        ...
        btnLifeTime.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    InappConsumer.getInstance(RokuSubOneActivity.this).buySubcription(RokuSubOneActivity.this);
                } catch (Exception e) {
                    Intent intent = new Intent(RokuSubOneActivity.this, RokuSubTwoActivity.class);
                    startActivity(intent);
                }
    ...
    public void buyFalseConsume() {
        Intent intent = new Intent(this, RokuSubTwoActivity.class);
        startActivity(intent);
    }
